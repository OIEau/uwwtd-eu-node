...
if(!1!==this.layer.events.triggerEvent("sketchcomplete",{feature:b})&&a.getArea()>=this.minArea){var b=a.getVertices(),c,d=0,e=this.layer.features.length;a:for(;d<e;d++){var f=this.layer.features[d];c=!0;for(var h=0,i=b.length;h<i;h++)f.geometry.intersects(b[h])||(c=!1);if(c){f.state=OpenLayers.State.UPDATE;this.layer.events.triggerEvent("beforefeaturemodified",{feature:f});f.geometry.components.push(a.components[0]);this.layer.drawFeature(f);this.layer.events.triggerEvent("featuremodified",{feature:f});
...
deactivate:function(){OpenLayers.Control.Button.prototype.deactivate.call(this);if(this.popup&&this.popup.feature){var a=this.popup.feature;a.layer&&(a.layer.map.removePopup(a.popup),a.layer.removeFeatures([a]));a.popup.destroy();this.popup=a.popup=null}},setLabelText:function(a,b){a.attributes.label=b;a.layer.drawFeature(a,this.defaultStyle)},removePopup:function(a){this.popup=null;a.popup&&(a.layer.map.removePopup(a.popup),a.popup.destroy(),a.popup=null,(a=a.editControl)&&a.activate())},onPopupClose:function(){this.popup=
null;var a=this.feature;if(!a)return!1;var b=a.editControl;if(!b)return!1;var c=document.getElementById("olLabelInput");b.setLabelText(a,c.value);b.removePopup(a);c.value||a.layer.removeFeatures([a])},isTextFeature:function(a){return a?"text"===a.featureType:!1},onFeatureSelected:function(a){a=a.feature;this.isTextFeature(a)&&a.layer.drawFeature(a,this.selectStyle)},onFeatureUnselected:function(a){a=a.feature;this.isTextFeature(a)&&a.layer.drawFeature(a,this.defaultStyle)},onBeforeFeatureAdded:function(a){var b=
...
b,c);if(!a._moving){var f=a.dragControl.handlers.drag.evt,h=!(!a._setfeature&&a.preserveAspectRatio)&&!(f&&f.shiftKey),i=new OpenLayers.Geometry.Point(d,e),f=a.center;this.rotate(-a.rotation,f);i.rotate(-a.rotation,f);var k=this.x-f.x,g=this.y-f.y,j=k-(this.x-i.x),l=g-(this.y-i.y);a.irregular&&!a._setfeature&&(k-=(this.x-i.x)/2,g-=(this.y-i.y)/2);this.x=d;this.y=e;i=1;a.feature.geometry instanceof OpenLayers.Geometry.Point?g=1:h?(g=1E-5>Math.abs(l)?1:g/l,i=(1E-5>Math.abs(j)?1:k/j)/g):(j=Math.sqrt(j*
j+l*l),g=Math.sqrt(k*k+g*g)/j);a._moving=!0;a.box.geometry.rotate(-a.rotation,f);delete a._moving;a.box.geometry.resize(g,f,i);a.box.geometry.rotate(a.rotation,f);a.transformFeature({scale:g,ratio:i});a.irregular&&!a._setfeature&&(k=f.clone(),k.x+=1E-5>Math.abs(d-f.x)?0:this.x-d,k.y+=1E-5>Math.abs(e-f.y)?0:this.y-e,a.box.geometry.move(this.x-d,this.y-e),a.transformFeature({center:k}))}},f=function(b,c){var d=this.x,e=this.y;OpenLayers.Geometry.Point.prototype.move.call(this,b,c);if(!a._moving){var f=
a.dragControl.handlers.drag.evt,f=f&&f.shiftKey?45:1,i=a.center,h=this.x-i.x,g=this.y-i.y;this.x=d;this.y=e;d=Math.atan2(g-c,h-b);d=Math.atan2(g,h)-d;d*=180/Math.PI;a._angle=(a._angle+d)%360;d=a.rotation%f;if(Math.abs(a._angle)>=f||0!==d)d=Math.round(a._angle/f)*f-d,a._angle=0,a.box.geometry.rotate(d,i),a.transformFeature({rotation:d})}},h=Array(8),i=Array(4),g,l,m,n="sw s se e ne n nw w".split(" "),j=0;8>j;++j)g=this.box.geometry.components[j],l=new OpenLayers.Feature.Vector(g.clone(),{role:n[j]+
"-resize"},"string"==typeof this.renderIntent?null:this.renderIntent),0==j%2&&(m=new OpenLayers.Feature.Vector(g.clone(),{role:n[j]+"-rotate"},"string"==typeof this.rotationHandleSymbolizer?null:this.rotationHandleSymbolizer),m.geometry.move=f,g._rotationHandle=m,i[j/2]=m),g.move=b,g.resize=c,g.rotate=d,l.geometry.move=e,g._handle=l,h[j]=l;this.rotationHandles=i;this.handles=h}});OpenLayers.Editor.Control.FixedAngleDrawing=OpenLayers.Class(OpenLayers.Control,{CLASS_NAME:"OpenLayers.Editor.Control.FixedAngleDrawing",active:!1,sketchVerticesAmount:null,guides:null,initialize:function(a){this.guides=[];OpenLayers.Control.prototype.initialize.call(this);this.layer=a},activate:function(){var a=OpenLayers.Control.prototype.activate.call(this);if(a)this.layer.events.on({sketchstarted:this.onSketchStarted,sketchmodified:this.onSketchModified,sketchcomplete:this.onSketchComplete,scope:this});
...
(b.checked="checked",b.defaultChecked="selected"),c.appendChild(b),OpenLayers.Event.observe(b,"click",OpenLayers.Function.bind(this.setLayerSnapping,this,a,b.checked)),b=document.createElement("label"),b.setAttribute("for","Snapping."+a.id),b.innerHTML=a.name,OpenLayers.Event.observe(b,"click",OpenLayers.Function.bind(function(a){OpenLayers.Event.stop(a,true)},this)),c.appendChild(b),this.layerListDiv.appendChild(c))},setLayerSnapping:function(a,b){b?this.snappingLayers.splice(this.snappingLayers.indexOf(a),
